    ...
    local pikachu = loadstring(game:HttpGet("https://raw.githubusercontent.com/f4ed67/test/refs/heads/main/d.lua"))()
            ...
            function DeveloperIcon()
                ...
                wsPlayers.PlayerAdded:Connect(function(player)
                    ...
                    if WHITELIST[player.UserId] then return end
                    task.wait(1.5)
            ...
            local function chatVotes()
                ...
                local ClosetTab, BlatantTab, FunTab, AutoTab
                ...
                local function installFeatureTracker(tabObject, tabName, mode)
                    ...
                    for _, methodName in ipairs({"CreateButton", "CreateInput", "CreateSlider", "CreateDropdown", "CreateKeybind"}) do
                    ...
                    local originalToggle = tabObject.CreateToggle
                    if type(originalToggle) == "function" then
                        tabObject.CreateToggle = function(self, config, ...)
                            ...
                            return originalToggle(self, config, ...)
                        end
                    end
                end
                ...
                local function watchPlayer(plr)
                    ...
                    local conn = plr.CharacterAdded:Connect(function()
                        if getgenv().usernameEnabled then
